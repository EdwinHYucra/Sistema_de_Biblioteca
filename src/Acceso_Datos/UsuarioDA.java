...
public class UsuarioDA {
    ...
    public void ModificarEstadoRecTec(int id_rec){
        String sql = "UPDATE RecursoTecnologico\n"
                + "set estado = 'no disponible'\n"
                + "where codigo = ?";
        ...
        try {
            ...
            System.out.println("Error al modificar estado Recurso Tecnologico: " + e.getMessage());
        }
    }
    public void ModificarEstadoSala(int id_sala){
        ...
        try {
            ...
            System.out.println("Error al modificar estado Sala: " + e.getMessage());
        }
    }
